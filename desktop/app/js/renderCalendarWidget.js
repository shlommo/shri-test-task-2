  ...
  for (let calendarTrigger of calendarTriggerArr) {
    calendarTrigger.addEventListener('click', () => {
      ...
      if (calendarTriggerDirection === 'left' && yearQuarter > 1) {
        ...
        moveCalendarWidget();
      } else if (calendarTriggerDirection === 'right' && yearQuarter < 4) {
        yearQuarter++;
        calendarWidget.setAttribute('data-quarter', yearQuarter);
        moveCalendarWidget();
      }
...
export default (calendarWidgetId) => {
  ...
  if (currentMonth <= 3) {
    calendarWidget.setAttribute('data-quarter', 1);
  } else if (currentMonth > 3 && currentMonth <= 6) {
    calendarWidget.setAttribute('data-quarter', 2);
  } else if (currentMonth > 6 && currentMonth <= 9) {
    calendarWidget.setAttribute('data-quarter', 3);
  } else {
    calendarWidget.setAttribute('data-quarter', 4);
  }
